...
if __name__ == '__main__':
  ...
  while True:
    ...
    clusterAX.append(AccelX)
    clusterAY.append(AccelY)
    clusterAZ.append(AccelZ)
    clusterGX.append(GyroX)
    clusterGY.append(GyroY)
    clusterGZ.append(GyroZ)

    if len(clusterAX) == 150000:
      break
    calc = True
  ...
  np.savez('IMU_output2.npz', GX=GX, GY=GY, GZ=GZ, AX=AX, AY=AY, AZ=AZ)
